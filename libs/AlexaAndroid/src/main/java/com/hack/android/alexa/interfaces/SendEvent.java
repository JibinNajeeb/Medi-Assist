package com.hack.android.alexa.interfaces;
...
public abstract class SendEvent {
     ...
     * @param url the URL we're posting to, this is either the default {@link com.hack.android.alexa.data.Directive} or {@link com.hack.android.alexa.data.Event} URL
    ...
    protected void prepareConnection(String url, String accessToken) {
        ...
        Log.d(TAG, "Send Event prepareConnection: "+ getEvent());
    ...
    protected Call completePost() throws IOException, AvsException, RuntimeException {
        Log.d(TAG, "completePost"+ getEvent());
    ...
    private Call parseResponse() throws IOException, AvsException, RuntimeException {
        ...
        Log.d(TAG, "parseResponse"+ request.toString());
    ...
    /**
     * Get our JSON {@link com.hack.android.alexa.data.Event} for this call
     * @return the JSON representation of the {@link com.hack.android.alexa.data.Event}
     */
    @NotNull
